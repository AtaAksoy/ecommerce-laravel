...
@endsection
@section('title', 'Şifremi Değiştir - Laravel'.config('app.title'))
                ...
                <div class="col-sm-6">
                    <nav aria-label="breadcrumb" class="theme-breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">ŞİFREMİ Değiştir</li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class="col-lg-6 offset-lg-3">
                    ...
                    <form class="theme-form" action="/customer/forgetpassword/send" method="POST">
                        ...
                        <div class="form-row">
                            ...
                            <button type="submit" href="#" class="btn btn-solid">Gönder</button>
                        </div>
                    </form>
                </div>
            </div>
