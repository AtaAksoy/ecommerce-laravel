...
@section('title', 'Kategori Düzenle | Yetkili - eCommerce')
                    ...
                    <form class="needs-validation" method="POST" action="?" enctype="multipart/form-data">
                        <div class="tab-pane fade active show" id="general" role="tabpanel" aria-labelledby="general-tab">
                                ...
                                <div class="form-group row">
                                    <label for="validationCustom0" class="col-xl-3 col-md-4"><span>*</span> İsim</label>
                                    <input name = "name" value="{{ $category->name }}" class="form-control col-xl-8 col-md-7" id="validationCustom0" type="text">
                                    <input type="hidden" value="{{ $category->slug }}" name="old_slug">
                                </div>
                                <div class="form-group row">
                                    ...
                                    <img src="/assets/images/category/{{ $category->image }}" width="400px" height="200px" class="rounded mx-auto d-block" alt="...">
                                </div>
                                <div class="form-group row editor-label">
                                    <label class="col-xl-3 col-md-4"><span>*</span> Açıklama</label>
                                    <div class="col-xl-8 col-md-7 editor-space">
                                        <textarea id="editor1" name="editor1" cols="30" rows="10">{{ $category->description }}</textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
