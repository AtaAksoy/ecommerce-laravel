            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="page-header-left">
                        <h3>Gösterge Paneli
                            <small>e-Commerce Yetkili Paneli</small>
                        </h3>
                    </div>
                </div>
                <div class="col-lg-6">
                ...
                <div class="card o-hidden widget-cards">
                    <div class="bg-warning card-body">
                        <div class="media static-top-widget row">
                            ...
                            <div class="media-body col-8"><span class="m-0">Kazanç</span>
                                <h3 class="mb-0">₺ <span class="counter">{{ $totalprice }}</span><small> Bu Ay</small></h3>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card o-hidden widget-cards">
                    <div class="bg-danger card-body">
                        <div class="media static-top-widget row">
                            ...
                            <div class="media-body col-8"><span class="m-0">Yeni Kullanıcılar</span>
                                <h3 class="mb-0"><span class="counter">{{ $customers->count() }}</span><small> Bu Ay</small></h3>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-6 footer-copyright">
                <p class="mb-0">Copyright 2020 © Ata AKSOY All rights reserved.</p>
            </div>
            <div class="col-md-6">
