...
<head>
    ...
    <title>@yield('title', 'Yetkili | e-Commerce')</title>
    @yield('header')
    <!-- Google font-->
    ...
    <div class="page-main-header">
        <div class="main-header-right row">
            <div class="main-header-left d-lg-none">
                <div class="logo-wrapper"><a href="{{ route('admin.dashboard') }}"><img class="blur-up lazyloaded" src="/assets/images/dashboard/multikart-logo.png" alt=""></a></div>
            </div>
                ...
                <ul class="nav-menus">
                    ...
                    <li class="onhover-dropdown"><i data-feather="bell"></i><span class="badge badge-pill badge-primary pull-right notification-badge">3</span><span class="dot"></span>
                        <ul class="notification-dropdown onhover-show-div p-0">
                            <li>Bildirim <span class="badge badge-pill badge-primary pull-right">3</span></li>
                            <li>
                                <div class="media">
                    ...
                    <li class="onhover-dropdown">
                        ...
                        <ul class="profile-dropdown onhover-show-div p-20 profile-dropdown-hover">
                            <li><a href="#"><i data-feather="user"></i>Profili Düzenle</a></li>
                            <li><a href="#"><i data-feather="mail"></i>Gelen Kutusu</a></li>
                            <li><a href="#"><i data-feather="lock"></i>Lock Screen</a></li>
                            <li><a href="#"><i data-feather="settings"></i>Ayarlar</a></li>
                            <li><a href="{{ route('admin.logout') }}"><i data-feather="log-out"></i>Çıkış</a></li>
                        </ul>
                    </li>
                </ul>
        ...
        <div class="page-sidebar">
            ...
            <div class="sidebar custom-scrollbar">
                <div class="sidebar-user text-center">
                    ...
                    <h6 class="mt-3 f-14">{{ Auth::guard('admins')->user()->name }}</h6>
                    <p>Yönetici</p>
                </div>
                <ul class="sidebar-menu">
                    <li><a class="sidebar-header" href="{{route('admin.dashboard')}}"><i data-feather="home"></i><span>Gösterge</span></a></li>
                    <li><a class="sidebar-header" href="{{ route('admin.announcement') }}"><i data-feather="bell"></i><span>Duyuru</span></a>
                    </li>
                    <li><a class="sidebar-header" href="#"><i data-feather="box"></i> <span>Ürünler</span><i class="fa fa-angle-right pull-right"></i></a>
                        <ul class="sidebar-submenu">
                            <li>
                                <a href="#"><i class="fa fa-circle"></i>
                                    <span>Fiziksel</span> <i class="fa fa-angle-right pull-right"></i>
                                </a>
                                <ul class="sidebar-submenu">
                                    <li><a href="{{ route('admin.category') }}"><i class="fa fa-circle"></i>Kategori</a></li>
                                    <li><a href="category-sub.html"><i class="fa fa-circle"></i>Sub Category</a></li>
                                    <li><a href="{{ route('admin.products.list') }}"><i class="fa fa-circle"></i>Ürün Listesi</a></li>
                                    <li><a href="product-detail.html"><i class="fa fa-circle"></i>Product Detail</a></li>
                                    <li><a href="{{ route('admin.products.add') }}"><i class="fa fa-circle"></i>Ürün Ekle</a></li>
                                </ul>
                            </li>
                        </ul>
                    </li>
                    <li><a class="sidebar-header" href="{{ route('admin.listDiscount') }}"><i data-feather="percent"></i><span>İndirim</span></a>
                    </li>
                    <li><a class="sidebar-header" href=""><i data-feather="dollar-sign"></i><span>Satışlar</span><i class="fa fa-angle-right pull-right"></i></a>
                        <ul class="sidebar-submenu">
                            <li><a href="{{ route('admin.orders.show') }}"><i class="fa fa-circle"></i>Siparişler</a></li>
                    ...
                    <li><a class="sidebar-header" href="#"><i data-feather="clipboard"></i><span>Blog</span><i class="fa fa-angle-right pull-right"></i></a>
                        <ul class="sidebar-submenu">
                            <li><a href="{{ route('admin.blog.list') }}"><i class="fa fa-circle"></i>Listele</a></li>
                            <li><a href="{{ route('admin.blog.createPage') }}"><i class="fa fa-circle"></i>Oluştur</a></li>
                        </ul>
                    </li>
                    ...
                    <li><a class="sidebar-header" href=""><i data-feather="settings" ></i><span>Ayarlar</span><i class="fa fa-angle-right pull-right"></i></a>
                        <ul class="sidebar-submenu">
                            <li><a href="{{ route('admin.settings.homepage') }}"><i class="fa fa-circle"></i>Anasayfa Ayarları</a></li>
