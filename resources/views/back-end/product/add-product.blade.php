...
@section('title', 'Ürün Ekle | e-Commerce')
                                        ...
                                        <div class="col-xl-7" style="margin-top: 20px;">
                                            <div class="form">
                                                <div class="form-group mb-3 row">
                                                    ...
                                                    <input class="form-control col-xl-8 col-sm-7" id="validationCustom01" name="name" type="text" required="">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <fieldset class="qty-box col-xl-9 col-xl-8 col-sm-7 pl-0">
                                                        <div class="input-group">
                                                            <input class="touchspin" name="stock" type="text" value="1">
                                                        </div>
                                                    </fieldset>
                                                </div>
                                                <div class="form-group row">
                                            ...
                                            <div class="form-group mb-3 row">
                                                ...
                                                <div class="input-group">
                                                    <input class="form-control col-xl-8 col-sm-7" id="validationCustomUsername" type="text" name="colors" required="">
                                            ...
                                            <div class="form-group mb-3 row">
                                                ...
                                                <div class="input-group">
                                                    <input class="form-control col-xl-8 col-sm-7" id="validationCustomUsername" type="text" name="size" required="">
