...
@section('title', 'Anasayfa '. config('app.title'))
    ...
    <section class="p-0">
        <div class="slide-1 home-slider">
            @php
                $bannerSettingArray = json_decode($bannerSettings, true);
                $bannerSettingBannerArray = json_decode($bannerSettingArray['value'], true);
                $i = 0;
            @endphp
            @foreach ($bannerSettingBannerArray as $banner => $value)
                @php
                    $i++;
                @endphp
                <div>
                    <div class="home text-center">
                        <img src="/assets/images/home-banner/{{ $value[$i]['image'] }}" alt="" class="bg-img blur-up lazyload">
                        <div class="container">
                            <div class="row">
                                <div class="col">
                                    <div class="slider-contain">
                                        <div>
                                            <h4>{{ $value[$i]['subtext'] }}</h4>
                                            <h1>{{ $value[$i]['maintext'] }}</h1>
                                            <a href="{{ $value[$i]['url'] }}" class="btn btn-solid">İncele</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <section class="pb-0 ratio2_1">
        <div class="container">
            <div class="row partition2">
                ...
                @php
                $smallbannerSettingArray = json_decode($smallbannerSettings, true);
                $smallbannerSettingBannerArray = json_decode($smallbannerSettingArray['value'], true);
                $i = 0;
            @endphp
            @foreach ($smallbannerSettingBannerArray as $banner => $value)
                @php
                    $i++;
                @endphp
                <div class="col-md-6">
                    <a href="#">
                        <div class="collection-banner p-right text-center">
                            <div class="img-part">
                                <img src="/assets/images/home-banner/{{ $value[$i]['image'] }}" class="img-fluid blur-up lazyload bg-img"
                                    alt="">
                            </div>
                            <div class="contain-banner">
                                <div>
                                    <h4>{{ $value[$i]['subtext'] }}</h4>
                                    <h2>{{ $value[$i]['maintext'] }}</h2>
                                </div>
                            </div>
                        </div>
                    </a>
    ...
    <div class="title1 section-t-space">
        <h4>ÖZEL TEKLİF</h4>
        <h2 class="title-inner1">KOLEKSİYON</h2>
    </div>
    <div class="container">
        <div class="row">
    ...
    <div class="title1 section-t-space">
        <h4>ÖZEL TASARIM</h4>
        <h2 class="title-inner1">ÖZEL ÜRÜNLER</h2>
    </div>
    <section class="section-b-space p-t-0 ratio_asos">
        <div class="container">
            <div class="row">
                <div class="col">
                    <div class="theme-tab">
                        <ul class="tabs tab-title">
                            <li class="current"><a href="tab-4">Yeni Ürünler</a></li>
                            <li class=""><a href="tab-5">Öne Çıkan Ürünler</a></li>
                            <li class=""><a href="tab-6">Çok Satanlar</a></li>
                        </ul>
                ...
                <div class="col-md-4 service-block">
                    <div class="media">
                        ...
                        <div class="media-body">
                            ...
                            <p>Tüm Türkiyeye Ücretsiz Kargo</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 service-block">
                    <div class="media">
                        ...
                        <div class="media-body">
                            <h4>24 X 7 servis</h4>
                            <p>Yeni Müşterilere 7/24 Servis</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 service-block">
                    <div class="media">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -14 512.00001 512">
                            ...
                            <path
                                ...
                                fill="#ff4c3b" /> </svg>
                        <div class="media-body">
                            <h4>özel indirimler</h4>
                            <p>İnternete Özel İndirimler</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col">
                <div class="title1 section-t-space">
                    <h4>Yeni İçerikler</h4>
                    <h2 class="title-inner1">blog</h2>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <div class="col-md-12">
                                <a href="#">
                                    <div class="classic-effect">
                                        <div>
                                            <img src="/assets/images/blog/{{ $blogs[$i]->image }}" class="img-fluid blur-up lazyload bg-img"
                                                alt="">
                                        </div>
                                        <span></span>
                                    </div>
                                ...
                                <div class="blog-details">
                                    <h4>{{ date('d/m/Y', strtotime($blogs[$i]->date)) }}</h4>
                                    <a href="{{ route('blog.showblog', $blogs[$i]->slug) }}">
                                        <p>{{ $blogs[$i]->title }}</p>
                                    </a>
                                    <hr class="style1">
                                    @php
                                        if ($blogs[$i]->comments == ""){
                                            ...
                                            $count_comment = json_decode($blogs[$i]->comments, true);
                                        }
                                    @endphp
                                    <h6>tarafından: {{ $blogs[$i]->posted_by }} , {{ count($count_comment) }} Yorum</h6>
                                </div>
                            </div>
                        @endfor
                    </div>
